...
//        LogUtils.e("onTaskRemoved方法执行");
////        getApplication().moveTaskToBack(true);
//        LogUtils.e(" service 还在运行吗？="+ CommonUtils.isServiceRunning(this));
//
...
//                new Intent(this, CurrentStepActivity.class), 0);
...
//            sensorManager.registerListener(StepService2.this, detectorSensor, SensorManager.SENSOR_DELAY_UI);
//        } else if (countSensor != null) {
//            sensorManager.registerListener(StepService2.this, countSensor, SensorManager.SENSOR_DELAY_UI);
//            //        addBasePedoListener();
//        } else {
