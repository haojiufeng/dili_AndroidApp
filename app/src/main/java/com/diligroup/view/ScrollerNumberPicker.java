...
public class ScrollerNumberPicker extends View {
    ...
    private static final int[] SHADOWS_COLORS = new int[]{0x88ffffff, 0xeaffffff, 0x66ffffff,0x33ffffff};
    /**
...
//        }
    ...
    private void initData() {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            switch (flag) {
                case 1:
                    itmItemObject.itemText = ((PrinceAndCitiesBean.ProvinceListBean) dataList.get(i)).getName();
                    break;
                case 2:
                    itmItemObject.itemText = ((PrinceAndCitiesBean.ProvinceListBean.CityListBean) dataList.get(i)).getName();
                    break;
                case 3:
                    itmItemObject.itemText = ((PrinceAndCitiesBean.ProvinceListBean.CityListBean.DistrictListBean) dataList.get(i)).getName();
                    break;
            }
    ...
    private void drawLine(Canvas canvas) {
        ...
        linePaint.setColor(Color.parseColor("#fdf3e3"));
...
//        canvas.drawRect(0, 0, controlWidth, maskHight, paint);
        canvas.drawRect(0, unitHeight*getSelected(), controlWidth, maskHight, paint);
...
//                controlHeight, paint2);
     ...
     * @param data
     */
    public void setData(List<?> data, int flag) {
        this.dataList = data;
        this.flag = flag;
        initData();
    }
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            canvas.drawText(itemText, x + controlWidth / 2 - textRect.width()
                    ...
                    textPaint);
//            canvas.drawLine(0,y+getHeight()/2 + 2,
//                    controlWidth,y+getHeight()/2 + 2, linePaint);
