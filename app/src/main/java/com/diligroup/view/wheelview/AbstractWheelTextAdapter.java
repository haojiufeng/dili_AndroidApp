        ...
        if (index >= 0 && index < getItemsCount()) {
            ...
            if (textView != null) {
                ...
                if (index == currentIndex) {
                    ...
                    textView.setBackgroundColor(context.getResources().getColor(R.color.little_orenge));
                } else {
...
//        view.setTextColor(Color.parseColor("#ff6632"));
//        view.setGravity(Gravity.CENTER);
//        view.setTextSize(24);
//        view.setBackgroundColor(context.getResources().getColor(R.color.common_orenge));
//        view.setLines(1);
