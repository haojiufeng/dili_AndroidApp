...
public class HomeRighAdapter extends RecyclerView.Adapter implements StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder> {
    ...
    public HomeRighAdapter(Context mContext, List<HomeStoreSupplyList.JsonBean.DishesSupplyListBean> mList, String date, String mealType, MyStickyHeadChangeListener listener) {
        super();
...
//        LogUtils.e("当前的headcode==",rightDishesList.get(position).getHeaderCode());
    ...
    public void onBindHeaderViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        hvh.sticklistHeadtext.invalidate();
    }
